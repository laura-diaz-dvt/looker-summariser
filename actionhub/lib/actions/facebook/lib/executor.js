    ...
    constructor(actionRequest, accessToken) {
        ...
        this.fieldMapping = [
            ...
            },
            {
                ...
                userField: "birthYear",
                normalizationFunction: (value) => (0, util_1.getYear)(this.normalize(value)),
            },
            {
                lookMLTagName: "birth_month",
                fallbackRegex: /month/i,
                userField: "birthMonth",
                normalizationFunction: (value) => (0, util_1.getMonth)(this.normalize(value)),
            },
            {
                lookMLTagName: "birth_day",
                fallbackRegex: /day/i,
                userField: "birthDay",
                normalizationFunction: (value) => (0, util_1.getDayOfMonth)(this.normalize(value)),
            },
            {
            ...
            },
            {
                ...
                normalizationFunction: (value) => (0, util_1.removeNonRomanAlphaNumeric)(this.normalize(value)),
            },
            {
                lookMLTagName: "city",
            ...
            },
            {
                ...
                userField: "state",
                normalizationFunction: (value) => (0, util_1.usStateNameTo2Code)(this.normalize(value)),
            },
            {
                lookMLTagName: "zip",
            ...
            },
            {
                ...
                userField: "country",
                normalizationFunction: (value) => (0, util_1.countryNameTo2Code)(this.normalize(value)),
            },
            {
            ...
            },
            {
                ...
                normalizationFunction: (value) => value, // NOOP
            },
        ];
